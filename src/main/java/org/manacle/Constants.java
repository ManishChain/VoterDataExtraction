...
public class Constants {
  ...
  public static String OUTPUT_FOLDER_PATH ; // = BASE + File.separator + GENERATED + File.separator + "output" ;
  public static String CSV_FOLDER_PATH ; // BASE + File.separator + GENERATED + File.separator + "csv" ;
